CLASS zcl_rap100_gen_data_rw7n DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_rw7n IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'RW7',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravrw7.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap100_atravrw7  FROM (
        SELECT
